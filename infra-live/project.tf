...
# All arguments requiring values to be set
  project_id      = "jpi-dev-project-1"       # Project ID entered explicitly
...
module "staging_project" {    
  ...
  project_id      = "jpi-staging-project-1"   # Different value provided here as we want a second project for staging
